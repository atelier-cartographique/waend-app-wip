...
import {addClass, removeClass, emptyElement,
    ...
    px, eventPreventer, getModelName} from '../lib/helpers';
...
class WebConsole extends Terminal {
    ...
    */
    ...
    start () {
        ...
        semaphore.on('terminal:run', (cmd) => this.runCommand(cmd));
        semaphore.on('start:loader', () => this.startLoader());
