...
type CoordPoint = GeoJSON.Position;
type CoordLinestring = GeoJSON.Position[];
type CoordPolygon = GeoJSON.Position[][];
...
export class Extent {
    ...
    constructor(extent: any) { // whether from an [minx, miny, maxx, maxy] extent or an Extent
